...
export default function Footer() {
  ...
  return (
    <footer className="absolute bottom-0 left-0 right-0 border-t-[1px] bg-white hidden xl:block">
      <div className="mx-auto container p-4 flex items-center justify-between text-sm flex-col sm:flex-row">
